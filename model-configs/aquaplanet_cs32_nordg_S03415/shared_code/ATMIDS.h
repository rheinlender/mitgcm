C $Header: /u/gcmpack/MITgcm/pkg/atm_ocn_coupler/ATMIDS.h,v 1.4 2015/11/12 00:43:34 jmc Exp $
C $Name:  $
...
c You need: a) to place you own copy of ATMIDS.h in a directory
c   (e.g.: shared_code) which is both in the include path of the
c   coupler and in the include path of the atmospheric component ;
